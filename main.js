              ...
              <div class="card data-id="${id}">
               ...
               ${encodeURIComponent(price)}&image= ${encodeURIComponent(image)}" target="_blank">
                ...
                <div class="card-body" style = " margin : 20px; ">
                  ...
                  <button  s data-id="${id}" class="card-button"  style="font-weight: bold; text-decoration: none; color: white; font-weight: bold; background-color: black;padding-left : 10px;">DELETE</button>
                </div>
              </div>
